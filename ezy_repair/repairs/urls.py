...
urlpatterns = [
    ...
    path('add_location/', views.add_site, name='add_location'),
    ...
    path('edit_locations/<int:pk>', views.edit_site, name='edit_location'),
    path('delete_locations/<int:pk>', views.delete_site, name='delete_location'),
    ...
    path('add-customer/', views.add_customer, name='add_customer1'),
]
